...
export default function CommunicationAssessmentModal({ onClose, onCompleted }) {
  ...
  const modalContent = (
    ...
    >
      <div className="max-w-3xl w-full max-h-[92vh] rounded-3xl border border-blue-500/30 flex flex-col overflow-hidden shadow-2xl bg-slate-950 relative z-[10000]">
